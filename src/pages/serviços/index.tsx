                ...
                <div className=' bg-white w-md h-92 flex flex-col rounded-[24px] shadow-lg shadow-gray-300 overflow-hidden '>
                    ...
                    <div className=' flex flex-col gap-4'>
                        ...
                        <div className='ml-8 mr-8'>
                            <p>Oferecemos desenvolvimento web, design de interfaces, consultoria técnica e suporte contínuo. Cada projeto é tratado com atenção única, garantindo entregas dentro do prazo e com a mais alta qualidade para cada cliente.</p>
                        </div>
                    </div>
                </div>
            </div>
